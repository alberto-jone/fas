...
namespace App\Models {
     ...
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\Member> $likedBy
     * @property-read int|null $likedBy_count
     * @property-read \App\Models\Member $member
     * @method static \Illuminate\Database\Eloquent\Builder<Article>|Article whereArticleId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Article>|Article whereTitle($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Article>|Article whereSummary($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Article>|Article whereContent($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Article>|Article whereCreated($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Article>|Article whereCategoryId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Article>|Article whereMemberId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Article>|Article whereImageId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Article>|Article wherePublished($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Article>|Article whereSeoTitle($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Category>|Category whereNavigation($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Category>|Category whereSeoName($value)
     ...
     * @property int $member_id
     * @property int $article_id
     * @property \Illuminate\Support\Carbon $posted
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Comment>|Comment wherePosted($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Comment>|Comment whereArticleId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Comment>|Comment whereMemberId($value)
     ...
     * @property-read \App\Models\Article $article
     * @method static \Illuminate\Database\Eloquent\Builder<Image>|Image whereImageId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Image>|Image whereFile($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Image>|Image whereAlt($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Like>|Like whereArticleId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Like>|Like whereMemberId($value)
     ...
     * @property-read int|null $likedArticles_count
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\Comment> $comments
     * @property-read int|null $comments_count
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\Token> $tokens
     * @property-read int|null $tokens_count
     * @method static \Illuminate\Database\Eloquent\Builder<Member>|Member whereMemberId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Member>|Member whereForename($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Member>|Member whereSurname($value)
     ...
     * @property-read \App\Models\Member $member
     * @method static \Illuminate\Database\Eloquent\Builder<Token>|Token whereTokenId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Token>|Token whereToken($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Token>|Token whereMemberId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Token>|Token whereExpires($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Token>|Token wherePurpose($value)
